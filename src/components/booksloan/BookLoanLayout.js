...
import {sassBooksLoanAll} from '../../api/server/ServerApi';
import {server_api, version_api} from '../../config/config';
import PageTitle from '../ui/header/PageTitle';
import BookLoanContent from './BookLoanContent';

class BookLoanLayout extends Component {
		...
		return (
				<div className={'sass-app'}>
					...
					<div className="container-fluid page-title">
						<PageTitle pagetitle={'Registro de libros prestados'}/>
					...
					<div className="container-fluid">
						<div className="container books mt-5 mb-5">
							<div className="row">
								<BookLoanContent sassbookloan={this.props.booksloan}/>
							</div>
						</div>
					</div>
...
const matchDispatchProps = (dispatch) => {
	return bindActionCreators({
		booksLoan: sassBooksLoanAll,
	}, dispatch);
};

export default connect(mapStateProps, matchDispatchProps)(BookLoanLayout);
